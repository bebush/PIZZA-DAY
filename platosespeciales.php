...
$productos = obtenerDatos($conn, "platosespeciales", $columnas, 6);
...
<head>
    ...
    <title>PizzaDay - Platos Especiales</title>
...
<body>
    ...
    <div class="menu-carrito" id="menu-carrito">
        <div class="contenedor-carrito">
            <!-- Aquí se actualizará dinámicamente el carrito -->
        </div>
    ...
    function enviarSolicitud(accion, nombre, precio) {
        fetch('actualizar_carrito.php', {
            ...
            body: `accion=${accion}&nombre=${nombre}&precio=${precio}`
        })
        .then(response => response.text())
        .then(data => {
            console.log(data);
            actualizarContador(nombre, accion);
        })
        .catch(error => console.error('Error:', error));
    }

    function actualizarContador(nombre, accion) {
